...
from day6.AutoRanzhi2018.function.base.base import *
"""
class ranzhi_db
作者：David
时间：
...
if __name__ == '__main__':
    ...
    mysqlExec = CommonDB("120.76.76.89", 3306, "ss_facaishu_com", "ss_facaishu_com", "aP906ohGVEzz19E", "utf8")

    strSql = "SELECT * FROM diyou_borrow_award_log WHERE award_type LIKE 'june_%' "
